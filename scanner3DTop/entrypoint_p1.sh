...
python3 gen_files_list.py 2020-02-01 RAW_DATA_PATH __Top-heading-east_0_g.png > raw_data_files.json
...
/home/u31/emmanuelgonzalez/cctools-7.1.6-x86_64-centos7/bin/makeflow -T wq --json main_workflow_phase1.json -a -N phytooracle_3d -p 9123 -dall -o dall.log $@
