...
/home/u31/emmanuelgonzalez/cctools-7.1.12-x86_64-centos7/bin/makeflow -T wq --json main_workflow_phase1.json -a -N phytooracle_3d -r 3 -p 9123 -dall -o dall.log $@
