...
?>
{
  ...
  "rules": [
...

    {
      ...
      "command": "singularity run -B $(pwd):/mnt --pwd /mnt docker://agpipeline/fieldmosaic:2.2 --result print --metadata ${METADATA} --working_space ${WORKING_SPACE} ${MOSAIC_LIST_FILE} ${SENSOR} \"${MOSAIC_BOUNDS}\"",
      "environment": {
        "MOSAIC_LIST_FILE": "<?=$MOSAIC_LIST_FILE?>",
...
#sudo docker run --rm --mount "src=`pwd`,target=/mnt,type=bind" agpipeline/fieldmosaic:2.0 -d --working_space "/mnt/" --metadata "/mnt/b7d9aefd-c8f8-4de6-8758-6af96bb7644e_metadata_cleaned.json" "/mnt/files.txt" "flirIrCamera" "-111.9750963 33.0764953 -111.9747967 33.074485715"
