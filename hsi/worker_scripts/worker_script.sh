...
${HOME}/cctools-7.1.12-x86_64-centos7/bin/slurm_submit_workers -p "--account=<account> --partition=standard --nodes=1 --ntasks=94 --cpus-per-task=1" -N phyto_oracle-atmo 94
