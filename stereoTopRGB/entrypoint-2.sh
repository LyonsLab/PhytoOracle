...
${HOME}/cctools-7.1.12-x86_64-centos7/bin/makeflow -T wq --json main_workflow_phase2.json -a -M phytooracle -N phytooracle -p 60221 -dall -o dall.log --disable-cache $@
