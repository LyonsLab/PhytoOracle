...
${HOME}/cctools-7.1.6-x86_64-centos7/bin/makeflow -T wq --json main_workflow_phase2.json -a -M phyto_oracle-atmo -N phyto_oracle-atmo -p 60221 -dall -o dall.log --disable-cache $@
