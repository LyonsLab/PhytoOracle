...
python3 gen_files_list.py 2020-01-20 > raw_data_files.json
...
${HOME}/cctools-7.1.12-x86_64-centos7/bin/makeflow -T wq --json main_workflow_phase1.json -a -r 150 -N phytooracle -M phytooracle -p 60221 -dall -o dall.log --disable-cache $@
