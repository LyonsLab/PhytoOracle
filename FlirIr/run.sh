...
singularity run -B $(pwd):/mnt --pwd /mnt ${SIMG_PATH}flir_plant_tempS11.simg -d ${DATE} -g season11_multi_latlon_geno.geojson -m model_weights_sorghum_flir.pth -c 4 ${PLOTCLIP_DIR}
